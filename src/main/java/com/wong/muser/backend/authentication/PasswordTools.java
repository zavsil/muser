...
public class PasswordTools {
  ...
  private static final String SALT = "D3xT1scEqMUmPZ9vtQp80fq67UG6uM1I";
  ...
  public static boolean verifyPassword(String providedPassword, String securedPassword) {
    return verifyPassword(providedPassword, securedPassword, SALT);
  }
  ...
  public static void main(String args[]) {
    System.out.println("Secure Password: " + generateSecurePassword("admin"));
  }
